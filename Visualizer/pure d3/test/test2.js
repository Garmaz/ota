...
function zoomed() {
    // yAxisG.call(yAxisG.scale(d3.event.transform.rescaleY(yScale)));
    var new_yScale = d3.event.transform.rescaleY(yScale);
    var new_xScale = d3.event.transform.rescaleY(xScale);
    {
        ...
        d3.select("#canvas").selectAll("rect")
            ...
            .attr('height', new_yScale.bandwidth())
...
render = (data) => {
    svg.call(d3.zoom().on("zoom",function(){
        ...
        // xAxisG.call(xAsis.scale(d3.event.transform.rescaleY(xScale)));
        var new_yScale = d3.event.transform.rescaleY(yScale);
        // var new_xScale = d3.event.transform.rescaleY(xScale);
